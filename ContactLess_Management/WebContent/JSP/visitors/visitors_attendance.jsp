...
<body>
	...
	<div>
		<nav><a href="LoginController">Home</a> <a
			href="VisitAttendController">Visitor's Attendance</a> <a
			href="VisitDetailsController">Visitor's Details</a> <a
			href="JSP/policies/read_policies.jsp">App Policies</a> <a href="#">Contact</a> <a
			href="VisitTempDetailsController">Temp Log</a>
