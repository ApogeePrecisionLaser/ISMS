 ...
 * @author Vikrant
 */
public class DeviceInfoRegController extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (JQstring != null) {
				...
				if (JQstring.equals("searchPersonId")) {
					...
					//list = dm.getPersonId(q, q2, q3, login_office_id);
				}
		...
		try {
			...
			dm.closeConnection();
			request.getRequestDispatcher("device_info_reg").forward(request, response);
